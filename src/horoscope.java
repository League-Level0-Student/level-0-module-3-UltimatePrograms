...
String horo = JOptionPane.showInputDialog("Enter zodiac sign(Aries Taurus Gemini Cancer Leo Virgo Libra Scorpio Sagittarius Capricorn Aquarius Pisces)");	
if (horo.equalsIgnoreCase("Aries")) {
	JOptionPane.showMessageDialog(null, "your horoscope is The symbol for this sign is that of a ram for good reason. Aries is full of life and possesses high energy, which makes this sign always looking for a challenge. The typical Aries person is full of vitality, curiosity, and has a heightened sense of justice. They often excel at anything where a bit of competition is involved, whether this is of a cognitive nature or physical. The challenge is the thing. If there is a chance to win, to best someone, to show off abilities, Aries is in it to win it. The Aries person feels most alive when they are in control and leading others. They are often impatient and abrupt with those whom they feel are not their equals and are in a leadership position. Most Aries do not like being told what to do if the person in charge is less talented than they.\n" + 
			"\n" + 
...
else if (horo.equalsIgnoreCase("Taurus")) {
	JOptionPane.showMessageDialog(null, "Tarus’s symbol is the bull because this sign’s characteristic is to be peaceful and methodical. This sign is often very deliberate in their actions, relaxed, and enjoys all of the sensual pleasures that abound in this dimension. Food, drink, sex, luxury, are all sought after by the typical taruean. Because this sign loves luxury they are willing to work hard to obtain it. They are slow to anger, but once disturbed it can be volatile. Taurus signs look for stability in their lives and in their partners and co-workers. Taurus people are not in a hurry, typically, and it can take them many years to decide what it is that they would like to do for a living, or where they’d like to go on vacation. Many of this sign prefer to live in the country as they are drawn to the earth and the natural world. Earth signs tend to have solid, reputable natures, which coincides with the Earth.\n" + 
			...
			"\n" + 
			"Upside: Taurus people almost always finish what they start. They are deliberate thinkers and when making decisions usually make the right one. Taurus are generally adaptable, adjusting easily to new circumstances especially if there is the reward of luxury, comfort, or sensual reward. This sign loves to laugh and spend time with family.\n" + 
			"\n" + 
...
else if (horo.equalsIgnoreCase("Gmini")) {
	JOptionPane.showMessageDialog(null, "The Gemini symbol is that of a pair of twins. This is because this sign rarely likes to do anything alone. Gemini are never happier than when they are sharing ideas and concepts with someone else. Communication is a key element for this sign, so many of this sign go into occupations that include some communication in some large capacity. Curiosity is a key characteristic of this sign, and they are people persons. Gemini are great at parties because they can find almost anything to talk about with anyone. Gemini are adventurous by nature and so engage in traveling as often as they can as it affords them the opportunity to meet new people, experience new ideas, and to learn new concepts.\n" + 
			...
			"\n" + 
			"Upside: Gemini are great conversationalists, and are charming people. Interesting to speak with, Gemini know a little bit about a lot of things. They have a great sense of humor and are generally optimistic people. Gemini often make their own fun, despising boredom.\n" + 
			"\n" + 
...
else if (horo.equalsIgnoreCase("Cancer")) {
...
else if (horo.equalsIgnoreCase("Leo")) {
...
else if (horo.equalsIgnoreCase("Virgo")) {
	JOptionPane.showMessageDialog(null, "The cool, calm, clarity that this sign exudes is why the symbol of the Maiden was chosen. Virgo people are mild mannered on the surface, but underneath there is a flurry of activity. Their minds are never quiet; always thinking, calculating, assessing. They loves making something out of nothing, nurturing and growing small things. They tend to be extremely detail oriented and particularly like producing something that is not only useful, but beautiful and skillful.\n" + 
			"\n" + 
			"Virgo don’t mind being alone as long as they know that they are appreciated and needed. They are sympathetic listeners, and are ready to help out those in need. Their good nature often makes them easy to take advantage of, and often they end up taking on more jobs and tasks than they should. This sign would do well to carefully consider the situation and the task before agreeing to take it on.\n" + 
			"\n" + 
			"Virgo is an Earth sign which means that they love making something from the land with their own hands. They do not tend to be loud or bossy, but are brilliant strategists and an asset to any team. Very often they will overburden themselves and take on more than they should, which makes their work suffer.\n" + 
			"\n" + 
...
else if (horo.equalsIgnoreCase("Libra")) {
...
else if (horo.equalsIgnoreCase("Scorpio")) {
...
else if (horo.equalsIgnoreCase("Sagittarius")) {
...
else if (horo.equalsIgnoreCase("Capricorn")) {
...
else if (horo.equalsIgnoreCase("Aquarius")) {
...
else if (horo.equalsIgnoreCase("Pisces")) {
...
//Aries Taurus Gmini Cancer Leo Virgo Libra Scorpio Sagittarius Capricorn Aquarius Pisces//